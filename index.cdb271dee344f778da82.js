...
var openPopupsBtns = document.querySelectorAll('.js-open-popup');
var closePopupsBtns = document.querySelectorAll('.js-close-popup');
...
if (openPopupsBtns.length) {
  openPopupsBtns.forEach(function (btn) {
    btn.addEventListener('click', openPopup.bind(event, btn));
  });
}
if (popup.length) {
  closePopupsBtns.forEach(function (btn) {
